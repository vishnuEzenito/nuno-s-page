			...
			>
				...
				>
					...
					>
						...
						>
							This toolkit translates key concepts and techniques
							into a set of tools to help address typical
							negotiation challenges. Start with the Negotiation
							Canvas and learn more about the other 50+ tools
						</Typography>
						<Box
							sx={{
								display: "flex",
