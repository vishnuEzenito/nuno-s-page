  ...
  return (<>
    ...
    <Box sx={{ mb:'4rem',mt:'4rem', display: 'flex',textAlign:'center', flexDirection: 'column', justifyContent: 'center', alignItems:'center', pb:'3rem',width:'100%', height: 'auto',px: isSmallScreen ? '1.25rem' : (isMediumScreen ? '4.5rem' : (isLargeScreen ? '4.5rem' : (isExtraLargeScreen ? '5.5rem' : '4.5rem')))}}>
      ...
      Train-the-Trainer support
          ...
          Contact us to request support to get trained as a coach
          </Typography>
      ...
      <TextField name="Org" id="org" placeholder="organisation" type='text' required sx={{background:'#F4F4F4',borderRadius:'12px',width:'100%'}}/>

      <TextField name="Course" id="course" placeholder="course" type='text' required sx={{background:'#F4F4F4',borderRadius:'12px',width:'100%'}}/>
