...
const Hero = () => {
  ...
  return (<>
    ...
    <Box sx={{  pb:'3rem',width:'100%', height: 'auto',px: isSmallScreen ? '1.25rem' : (isMediumScreen ? '4.5rem' : (isLargeScreen ? '4.5rem' : (isExtraLargeScreen ? '5.5rem' : '4.5rem')))}}>
  <Grid container spacing={{ xs:2, md:2, xl: 4 }} sx={{flexWrap: 'wrap-reverse',pt:isSmallScreen?'2rem':'4rem',justifyContent:'space-between'}}>
      ...
      50+ powerful tools to negotiate a better job, life, community, and world
          ...
          Adopt empowering mindsets, connect, build, and close deals like an expert, and keep improving for best impact
          </Typography>
